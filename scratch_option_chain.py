...
class OptionChainPage(QWidget):
    ...
    def setup_ui(self):
        ...
        title = QLabel("🔮 Options Strategy Engine")
        title.setStyleSheet("font-size: 24px; font-weight: 800; color: #E0E0E0; letter-spacing: 1px;")
        ...
        for lbl in [self.lbl_trend, self.lbl_momentum, self.lbl_bias, self.lbl_countdown]:
            lbl.setStyleSheet("font-size: 14px; font-weight: bold; background: #262933; border: 1px solid #3A3F4C; padding: 8px 12px; border-radius: 6px; color: #B0BEC5;")
        ...
        box1.setStyleSheet("QGroupBox { border: 1px solid #3A3F4C; border-radius: 6px; padding-top: 15px; margin-top: 10px; } QGroupBox::title { color: #90CAF9; subcontrol-origin: margin; left: 10px; padding: 0 5px; font-weight: bold; } QLabel { font-size: 13px; }")
        grid1 = QGridLayout()
        ...
        box3.setStyleSheet("QGroupBox { border: 1px solid #5C6BC0; border-radius: 6px; padding-top: 15px; margin-top: 10px; background: rgba(92, 107, 192, 0.05); } QGroupBox::title { color: #C5CAE9; subcontrol-origin: margin; left: 10px; padding: 0 5px; font-weight: bold; } QLabel { font-size: 13px; }")
        grid3 = QGridLayout()
        ...
        self.table.setStyleSheet("""
            QTableWidget { background-color: #1A1C23; color: #E0E0E0; border: 1px solid #2D3039; gridline-color: #2D3039; }
            QTableWidget::item:selected { background-color: #3949AB; color: white; }
            QHeaderView::section { background-color: #252831; color: #B0BEC5; padding: 6px; font-weight: 600; border: 1px solid #1A1C23; }
        """)
    ...
    def process_selected_expiry(self):
        ...
        if self.ai_res['sentiment'] == "Bullish": self.lbl_trend.setStyleSheet("color: #81C784; font-weight: bold; background: #1B5E20; border: 1px solid #388E3C; padding: 8px 12px; border-radius: 6px;")
        elif self.ai_res['sentiment'] == "Bearish": self.lbl_trend.setStyleSheet("color: #E57373; font-weight: bold; background: #B71C1C; border: 1px solid #D32F2F; padding: 8px 12px; border-radius: 6px;")
        else: self.lbl_trend.setStyleSheet("font-size: 14px; font-weight: bold; background: #262933; border: 1px solid #3A3F4C; padding: 8px 12px; border-radius: 6px; color: #B0BEC5;")
