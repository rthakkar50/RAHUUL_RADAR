...
class IntradayResultsTable(QTableWidget):
    ...
    def populate(self, results):
        ...
        headers = [
            ...
            "Stop Loss", "Target 1", "Target 2", "Timestamp"
        ]
        ...
        for row, r in enumerate(results):
            ...
            if conf_val >= 90: item_conf.setForeground(QBrush(QColor("#2E7D32"))) # Dark Green
            elif conf_val >= 75: item_conf.setForeground(QBrush(QColor("#81C784"))) # Light Green
            elif conf_val >= 50: item_conf.setForeground(QBrush(QColor("#FF9800"))) # Orange
            else: item_conf.setForeground(QBrush(QColor("#F44336"))) # Red
