...
class WatchlistTable(QTableWidget):
    ...
    def populate(self, results):
        ...
        headers = [
            "Symbol", "Company", "Sector", "Signal", "Price", 
            "Change %", "Confidence", "Score", "Trend", "Volume", "Last Updated"
        ]
        ...
        for row, r in enumerate(results):
            ...
            self.setItem(row, 1, QTableWidgetItem(str(r.get("Company", ""))))
            ...
            self.setItem(row, 5, QTableWidgetItem(str(r.get("Change %", "0.0%"))))
            ...
            self.setItem(row, 7, QTableWidgetItem(str(r.get("Score", ""))))
            self.setItem(row, 8, QTableWidgetItem(str(r.get("Trend", ""))))
            ...
            self.setItem(row, 9, item_vol)
            
            self.setItem(row, 10, QTableWidgetItem(str(r.get("Last Updated", ""))))
