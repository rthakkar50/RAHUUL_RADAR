...
symbols_exception = sum(1 for x in process_post_scan_returns if x == "EXCEPTION")
symbols_entering_quality = len(process_post_scan_returns) - symbols_returning_none - symbols_exception
