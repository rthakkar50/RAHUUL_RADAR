...
# We'll just monkey patch process_post_scan right before it gets passed to ThreadPoolExecutor
# No, we can't because it's an inner function.

# Let's just monkey-patch ScannerEngine.scan_market to intercept the raw ScanResults!
...
def hooked_evaluate(self, stock_list, *args, **kwargs):
    ...
    # Save the raw_results to disk or global variable
...
print("Running scan to intercept raw_results...")
service.execute_swing_scan()

print(f"Intercepted {len(my_raw_results)} results. Processing...")
